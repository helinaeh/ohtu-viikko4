...
import olutopas.domain.EbeanSqliteDatamapper;
import olutopas.komennot.Komento;
import olutopas.komennot.Komentotehdas;
    ...
    public void run(boolean newDatabase) {
        ...
        while (true) {
            ...
            try {
                ...
                Komento k = komennot.getKomento(komento-1);
                k.run(scanner, server, user);
            }
            catch (Exception e) {
